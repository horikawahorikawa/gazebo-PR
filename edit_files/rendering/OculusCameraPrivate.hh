...
namespace gazebo
{
  namespace rendering
  {
    ...
    class GZ_RENDERING_VISIBLE OculusCameraPrivate
    {
      ...
      public: cv::Mat dist0;
      public: cv::Mat dist1;
      public: MJPEGCapture rightCapture, leftCapture;
      public: cv::Mat mjpeg0, mjpeg1;
      public: int ovrtextureLeftWidth, ovrtextureLeftHeight, ovrtextureRightWidth, ovrtextureRightHeight;
      public: double i;
    };
  }
}
