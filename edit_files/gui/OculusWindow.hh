...
namespace gazebo
{
  namespace gui
  {
    ...
    class GAZEBO_VISIBLE OculusWindow : public QWidget
    {
      ...
      public: void OculusCameraParameter(float FOV_angle);
      public: void OculusChangePose(float Input_roll, float Input_pitch, float Input_yaw);
      public: void ConnectROStoVicon();
    };
  }
}
#endif
