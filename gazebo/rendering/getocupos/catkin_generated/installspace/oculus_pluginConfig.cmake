...
if("FALSE" STREQUAL "TRUE")
  ...
  set(oculus_plugin_DEVEL_PREFIX /home/rts/gazebo-6.1.0/gazebo/rendering/getocupos/devel)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'oculus_plugin' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  Ask the maintainer 'Yoonseok Pyo <passionvirus@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /usr/local/lib;/home/rts/catkin_ws/devel/lib;/opt/ros/indigo/lib)
